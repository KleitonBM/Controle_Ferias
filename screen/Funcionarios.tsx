...
export default function Funcionarios({ employees = [], schedules = [], onSave, onUpdate, onBack }) {
    ...
    const [statusAtivo, setStatusAtivo] = useState(true); // Booleano: true = Ativo, false = Inativo
    ...
    const openEditModal = (emp) => {
        ...
        // Ajuste para ler booleano do banco
    ...
    const handleSave = () => {
        ...
        // Enviando o campo status como booleano para o Supabase
        const payload = { 
            nome, 
            matricula, 
            admissao, 
        ...
        <View style={styles.empCard}>
            <View style={{ flex: 1 }}>
                <View style={styles.rowAlign}>
                    ...
                    {/* Exibição baseada no valor booleano */}
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <Text style={styles.label}>Grupo de Escala (Letra)</Text>
